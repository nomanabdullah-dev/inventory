                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading d-flex justify-content-between align-items-center">
                            <h3 class="panel-title" style="display: inline">All Pending Orders</h3>
                        </div>
                                                    ...
                                                    <tbody>
                                                        @foreach ($pending as $row)
                                                            <tr role="row" class="odd">
                                                                <td class="sorting_1">{{ $row->customer->name }}</td>
                                                                ...
                                                                <td>
                                                                    <a href="{{ route('view.order.status', $row->id) }}" class="btn btn-primary"><i class="fa fa-eye   "></i></a>

                                                                    <button onclick="deleteItem(this)" data-url="{{ route('order.destroy', $row->id) }}" id="delete" class="btn btn-danger"><i class="fa fa-trash"></i>
                                                                    </button>
