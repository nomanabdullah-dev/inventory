                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading d-flex justify-content-between align-items-center">
                            <h3 class="panel-title" style="display: inline">All categorys</h3>
                            <a href="{{ route('category.create') }}" class="btn btn-warning" style="float: right">Add Category</a>
                        </div>
                                                        ...
                                                        @foreach ($categories as $category)
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <button onclick="deleteItem(this)" data-url="{{ route('category.destroy', $category->id) }}" id="delete" class="btn btn-danger"><i class="fa fa-trash"></i>
                                                                    </button>
