...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Today's Expense</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="{{ route('dashboard') }}">Dashboard</a></li>
                        <li class="active">Today's Expense</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading d-flex justify-content-between align-items-center">
                            <h3 class="panel-title" style="display: inline">Today's Expenses</h3>
                            <h4 style="display: inline; margin-left:230px" class="text-white">Today's Total Expenses: {{ $today_Sum }}</h4>
                                                    ...
                                                    <tbody>
                                                        @foreach ($todays as $today)
                                                            <tr role="row" class="odd">
                                                                <td class="sorting_1">{{ $today->title }}</td>
                                                                <td>{{ $today->details }}</td>
                                                                <td>{{ $today->amount }}</td>

                                                                <td>
                                                                    <a href="{{ route('expense.edit', $today->id) }}" class="btn btn-primary"><i class="fa fa-pencil"></i></a>

                                                                    <button onclick="deleteItem(this)" data-url="{{ route('expense.destroy', $today->id) }}" id="delete" class="btn btn-danger"><i class="fa fa-trash"></i>
                                                                    </button>
                                                                </td>
                                                            </tr>
                                                        @endforeach
