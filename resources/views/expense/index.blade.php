                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading d-flex justify-content-between align-items-center">
                            <h3 class="panel-title" style="display: inline">All Expenses</h3>
                                                    ...
                                                    <tbody>
                                                        @foreach ($expenses as $expense)
                                                            <tr role="row" class="odd">
                                                                <td class="sorting_1">{{ $expense->title }}</td>
                                                                <td>{{ $expense->details }}</td>
                                                                <td>{{ $expense->amount }}</td>

                                                                <td>
                                                                    <a href="{{ route('expense.edit', $expense->id) }}" class="btn btn-primary"><i class="fa fa-pencil"></i></a>

                                                                    <button onclick="deleteItem(this)" data-url="{{ route('expense.destroy', $expense->id) }}" id="delete" class="btn btn-danger"><i class="fa fa-trash"></i>
                                                                    </button>
                                                                </td>
                                                            </tr>
                                                        @endforeach
