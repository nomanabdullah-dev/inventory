            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active">All Advanced Salaries</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading d-flex justify-content-between align-items-center">
                            <h3 class="panel-title" style="display: inline">All Advanced Salaries</h3>
                            <a href="{{ route('advancedsalary.create') }}" class="btn btn-warning" style="float: right">Add Advanced Salary</a>
                        </div>
                                                    ...
                                                    <tbody>
                                                        @foreach ($adsalaries as $adsalary)
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td>
                                                                    <a href="{{ route('advancedsalary.edit', $adsalary->id) }}" class="btn btn-primary"><i class="fa fa-pencil"></i></a>

                                                                    <button onclick="deleteItem(this)" data-url="{{ route('advancedsalary.destroy', $adsalary->id) }}" id="delete" class="btn btn-danger"><i class="fa fa-trash"></i>
                                                                    </button>
